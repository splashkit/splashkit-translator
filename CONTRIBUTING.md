...
- [SplashKit Documentation Guidelines](#splashkit-documentation-guidelines)
  ...
  - [Attributes](#attributes)
    ...
    - [`group`](#group)
    - [`note`](#note)
      - [Unknown attribute issue](#unknown-attribute-issue)
  - [Summary of Parser Rules](#summary-of-parser-rules)
